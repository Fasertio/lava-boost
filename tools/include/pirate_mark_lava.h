...
#ifdef TARGET_ARM
inline
void hypercall(void *buf, unsigned long len, long label, unsigned long off, void *pmli, int action) {   
    ...
    asm __volatile__
      ...
      : /* no output registers */
      : "r" (r0), "r" (r1), "r" (r2), "r" (r3), "r" (r4) , "r" (r5) /* input operands */
